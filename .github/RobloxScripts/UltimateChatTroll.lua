...
game.StarterGui:SetCore("SendNotification",  {
	...
	Text = "Chat Spy Activated.";
	Icon = "rbxassetid://3875725650";
	Duration = 3;
		...
		elseif enabled and (spyOnMyself==true or p~=player) then
			...
			if hidden and enabled then
				if public then
					...
					game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("".."["..Action[i].Name.."]".." "..msg,"All")
